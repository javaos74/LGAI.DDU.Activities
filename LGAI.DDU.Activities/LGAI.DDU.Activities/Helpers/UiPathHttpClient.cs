...
namespace LGAI.DDU.Activities.Helpers
{
    ...
    public class UiPathHttpClient
    {
        ...
        public async void AddFileResource(IResource file, string fieldName = "inputs")
        {
        ...
        public async Task<LGAIDDUResponse> Analyze()
        {
        ...
        public async Task<LGAIDDUResponse> GetResult( string reqId)
        {
